import type { ColorSystemOptions, Theme } from '@mui/material/styles'

import COLORS from './colors.json'
// Update import path to avoid bug that causes document to reload when compiling API routes
import { varAlpha, createPaletteChannel } from '../styles/utils'

// ----------------------------------------------------------------------

// Removed `createPalette` path to satisfy type errors in `@riptech/shared-ui`
